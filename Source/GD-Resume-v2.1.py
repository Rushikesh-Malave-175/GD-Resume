...
def show_filename_change_message():
    filename_comment.configure(text="You might want to rename the downloaded file :)", fg="green")
...
generate_button = tk.Button(root, text="Generate Direct Download Link", command=generate_link, height=1, font=("Arial", font_size))
generate_button.pack(pady=10)

# Create the output field
output_label = tk.Label(root, text="Generated Direct Download Link:", font=("Arial", font_size))
...
support_button = tk.Button(button_frame, text="Support Me", command=open_support_page, height=1, font=("Arial", font_size))
...
filename_comment = tk.Label(comment_frame, text="You might want to rename the downloaded file :)", fg="green", font=("Arial", font_size))
